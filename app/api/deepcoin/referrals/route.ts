...
export async function GET(req: NextRequest) {
  try {
    ...
    console.log("=== DeepCoin API Request Debug ===");
    console.log("URL:", url);
    ...
    console.log("Headers:", {
      "DC-ACCESS-KEY": API_KEY.substring(0, 8) + "...",
    ...
    console.log("=== DeepCoin API Response Debug ===");
    ...
    console.error("DeepCoin referrals fetch error:", error);
    return NextResponse.json(
