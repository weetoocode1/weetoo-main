...
export const EXCHANGES: Exchange[] = [
  {
    ...
    averageRebatePerUser: "$2,600",
    tags: ["TOP", "LEADER"],
    description:
      "Binance is the world's largest crypto exchange by volume, offering deep liquidity, advanced trading tools, and a robust ecosystem for both spot and derivatives traders.",
    features: [
      "Deep liquidity and tight spreads",
      "Comprehensive product ecosystem",
      "Advanced tools and risk controls",
    ],
  },
  {
    id: "bybit",
