...
export default function BuyLongButton(props: {
  isHost: boolean;
  ...
  const rrCalc = computeRiskReward(entry, qty, slPct, tpPct, "long");
  ...
  const slToLiqPct =
    rrCalc.stopPrice && liq > 0
      ? (((rrCalc.stopPrice as number) - liq) / entry) * 100
      : 0;
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="rounded-md border border-border bg-muted/50 px-4 py-3">
              <div className="grid gap-2">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-[13px] text-green-500">
                    {t("actions.buyLong")}
                  </span>
                </div>
                <div className="flex justify-between items-center">
            ...
            <div className="order-4 rounded-md border border-border bg-muted/50 px-4 py-3">
              <div className="grid grid-cols-2 gap-2 items-center">
                ...
                <span className="justify-self-end font-extrabold text-[20px] text-green-500 mt-1">
                  ${totalUsd.toFixed(2)}
                </span>
              </div>
              ...
              <div className="mt-3 text-[12px] text-muted-foreground">
                ...
                <div>
                  - Limit Buy {qty.toFixed(6)} {symbol.replace("USDT", "")} @ $
                  {format2(entry)}
                </div>
                {showDelta && (
                  <div>
                ...
                {slPct > 0 && (
                  <div>
                    - Stop Loss: Market Sell @ ${format2(rrCalc.stopPrice)} (-$
                    {format2(risk)})
                  </div>
                )}
                {tpPct > 0 && (
