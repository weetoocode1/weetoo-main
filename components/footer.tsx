...
export function Footer() {
  ...
  const tSupport = useTranslations("customerSupport");
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              <Dialog modal={false}>
                <DialogTrigger asChild>
                  <button
                    type="button"
                    aria-label={t("customerCenter")}
                    className="group flex items-center justify-between p-3 rounded-lg bg-muted/30 hover:bg-muted/50 transition-colors w-full cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
                  >
                    <span className="text-sm text-muted-foreground group-hover:text-foreground">
                      {t("customerCenter")}
                    </span>
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="font-semibold text-base">
                          {tSupport("kakaoTalkConsultation")}
                        </div>
                        <div className="text-xs text-gray-600 dark:text-gray-300">
                          {tSupport("clickToGo")}
                        </div>
                        <div className="text-xs mt-1 text-gray-500 dark:text-gray-400">
                          {tSupport("depositWithdrawal")}{" "}
                          <span className="mx-1">|</span>{" "}
                          {tSupport("inconvenience")}{" "}
                          <span className="mx-1">|</span>{" "}
                          {tSupport("relatedInquiries")}
                        </div>
                      </div>
                    </Link>
                    <Link
